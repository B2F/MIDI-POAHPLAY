## pro_micro_dual_mux_example wiring map

Topology: `DualMuxWiringProfile` (MUX1 + MUX2)
...
| mux2Sig | PIN | 0 | input | CD74HC4067 #2 SIG |
| mux2S0 | PIN | A1 | output | CD74HC4067 #2 address S0 (shared) |
| mux2S1 | PIN | A2 | output | CD74HC4067 #2 address S1 (shared) |
| mux2S2 | PIN | A3 | output | CD74HC4067 #2 address S2 (shared) |
| mux2S3 | PIN | A4 | output | CD74HC4067 #2 address S3 (shared) |
...
| swCcChannel | MUX2 | 0 | input | Mode switch CC |
| swRepeatChannel | MUX2 | 1 | input | Mode switch REPEAT |
| swUltrasonicChannel | MUX2 | 10 | input | Mode switch ULTRASONIC |
| swPlayChannel | MUX2 | 11 | input | Mode switch PLAY |
